...
CUDA_VISIBLE_DEVICES=8 python tools/test.py configs/polyp/solov2_r50_fpn_polyp_8gpu_3x.py work_dirs/solov2_r50_fpn_8gpu_3x_poly/latest.pth --eval segm --out work_dirs/solov2_r50_fpn_8gpu_3x_poly/result.pkl
