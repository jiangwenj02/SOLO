...
OMP_NUM_THREADS=8 CUDA_VISIBLE_DEVICES=4,5,6,7,8,9,10,11 ./tools/dist_train.sh configs/adenomatous/solov2_r50_fpn_adenomatous_8gpu_3x.py 8
...
CUDA_VISIBLE_DEVICES=8 python tools/test_ins.py configs/gangganpinghang/solov2_r50_fpn_gang_left_8gpu_3x.py work_dirs/solov2_r50_fpn_gang_left_8gpu_3x/latest.pth --eval segm --json_out work_dirs/solov2_r50_fpn_gang_left_8gpu_3x/result.json
