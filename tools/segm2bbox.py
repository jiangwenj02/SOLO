...
def segm2bbox(segm_json_file, bbox_json_file):
...
def main():
    segm2bbox('work_dirs/solov2_r50_fpn_adenomatous_8gpu_3x/result.pkl.segm.json', 'work_dirs/solov2_r50_fpn_adenomatous_8gpu_3x/result.pkl.bbox.json')
